...
const StatCard = ({ title, value, icon: Icon, color, delay }) => (
  <motion.div
    ...
    className="glass-card p-6 flex items-center gap-4 hover:border-slate-600 transition-colors cursor-pointer group"
  >
    ...
    <div className="max-w-7xl mx-auto space-y-8">
      <header className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-400 mt-1">Delhi-Dehradun Expressway Real-time Analytics</p>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <h3 className="text-lg font-bold text-slate-200 mb-6">Traffic Volume Trends</h3>
        ...
        >
          <h3 className="text-lg font-bold text-slate-200 mb-6">Top Busiest Plazas</h3>
